...
@interface ACSelectMediaView ()<UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, TZImagePickerControllerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, MWPhotoBrowserDelegate,UIActionSheetDelegate>
...
- (void)openAlbum {
    ...
    [[self viewControllerSupportView:self] presentViewController:imagePickController animated:YES completion:nil];
}
...
- (void)openCamera {
    ...
    if ([UIImagePickerController isSourceTypeAvailable: sourceType]){
        ...
        [[self viewControllerSupportView:self] presentViewController:picker animated:YES completion:nil];
    }else{
