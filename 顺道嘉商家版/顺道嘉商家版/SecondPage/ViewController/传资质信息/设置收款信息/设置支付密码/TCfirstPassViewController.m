...
@interface TCfirstPassViewController ()<UITextFieldDelegate,UIGestureRecognizerDelegate>
{
...
@implementation TCfirstPassViewController
...
-(void)clickSure:(UIButton *)sender{
    TCagainPwdViewController *againVC = [[TCagainPwdViewController alloc]init];
    againVC.titleStr = @"设置密码";
    againVC.onePass = self.nePass;
    againVC.entranceTypeStr = self.entranceTypeStr;
