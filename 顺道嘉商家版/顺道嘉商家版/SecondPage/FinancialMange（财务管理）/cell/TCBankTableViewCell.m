...
@implementation TCBankTableViewCell
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        self.contenView.frame = CGRectMake(0, 0, WIDHT - 24, 102);
        ...
        //卡的名字
        _titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(self.imageTop.frame) + 12, 12 , WIDHT - 44 - 24 - 12 - 12 - 24 , 20)];
        ...
        //卡的类型
        self.disLabel = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(self.imageTop.frame) + 12,  CGRectGetMaxY(self.titleLabel.frame) + 4, WIDHT - 24 - 24 - 44 - 12 - 12, 16)];
        ...
        //卡号
        self.cardLabel = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(self.imageTop.frame) + 12 ,  102 - 12 - 24, WIDHT - 24 - 24 - 44 - 24 , 24)];
...
-(void)setModel:(TCBankCardInfo *)model{
    ...
    self.titleLabel.text = [NSString stringWithFormat:@"中国%@银行",model.bank];
