...
- (void)drawView {
    if (!_paymentAlert) {
        _paymentAlert = [[UIView alloc]initWithFrame:CGRectMake(0, HEIGHT - 216 - 146,WIDHT, ALERT_HEIGHT)];
        ...
        UIButton *closeBtn = [[UIButton alloc]initWithFrame:CGRectMake(WIDHT - 12 - 17, 12, 17, 17)];
        ...
        _inputView = [[UIView alloc]initWithFrame:CGRectMake(24, CGRectGetMaxY(_titleLabel.frame) + 24, WIDHT-48, 52)];
        ...
        _forgetBtn = [[UIButton alloc]initWithFrame:CGRectMake(WIDHT - 55 - 24, CGRectGetMaxY(_inputView.frame) + 8, 55, 16)];
...
- (void)show {
    ...
    frame = CGRectMake(0, HEIGHT, WIDHT, 146);
...
//        _paymentAlert.transform = CGAffineTransformMakeScale(1.0f, 1.0f);
        CGRect frame = _paymentAlert.frame;
        frame = CGRectMake(0, HEIGHT - 216 - 146, WIDHT, 146);
        [_paymentAlert setFrame:frame];
