...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *left = [[UIBarButtonItem alloc] initWithTitle:@"<" style:UIBarButtonItemStylePlain target:self action:@selector(pop)];
    left.tintColor = NaviTitleColor;
    ...
    finish.tintColor = NaviTitleColor;
